...
class ProfileImageScreen extends StatelessWidget {
  String profilePhoto;
  ProfileImageScreen({Key? key, required this.profilePhoto}) : super(key: key);
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      await settingsController.uploadImage(context: context);
                      VxToast.show(context, msg: "Profile Photo Updated.");
